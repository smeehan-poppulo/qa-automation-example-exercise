...
| **Parameterised / data-driven tests** | [parameterised-tests.md](core/parameterised-tests.md), [test-data.md](core/test-data.md)                                                      |
| **Snapshot testing (text/JSON)**      | [snapshot-testing.md](core/snapshot-testing.md)                                                                                               |
...
| **TypeScript configuration**            | [typescript-configuration.md](core/typescript-configuration.md), [configuration.md](core/configuration.md)               |
| **Managing env vars & secrets**         | [environment-secrets.md](core/environment-secrets.md), [global-setup.md](core/global-setup.md)                           |
| **Monorepo / multi-package setup**      | [monorepo.md](infrastructure-ci-cd/monorepo.md), [projects-dependencies.md](core/projects-dependencies.md)               |
...
│  ├─ Parameterised / data-driven → core/parameterised-tests.md
│  ├─ Snapshot test (text/JSON) → core/snapshot-testing.md
...
│  ├─ Monorepo setup → infrastructure-ci-cd/monorepo.md
...
│  ├─ TypeScript config → core/typescript-configuration.md
│  ├─ Env vars & secrets → core/environment-secrets.md
