...
**62 reference documents** organized into 8 categories:
...
| TypeScript config     | `typescript-configuration.md` | tsconfig, typed fixtures, path aliases             |
| Environment & secrets | `environment-secrets.md`      | .env strategy, validation, CI secrets              |
| Parameterised tests   | `parameterised-tests.md`      | for…of, describe.configure, option fixtures        |
| Snapshot testing      | `snapshot-testing.md`         | Text/JSON snapshots, inline snapshots, CI workflow |
...
| Monorepo          | `monorepo.md`          | Multi-package setup, shared fixtures, CI |
